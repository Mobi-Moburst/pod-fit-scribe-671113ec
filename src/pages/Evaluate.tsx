    ...
    try {
      ...
      if (!notes) {
        ...
        if (!isAllowedPodcastUrl(url)) {
          toast({ title: 'Unsupported URL', description: 'Please use an Apple Podcasts, Spotify, or Listen Notes URL.', variant: 'destructive' });
          return;
        }
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <Card className="p-4 card-surface md:col-span-2">
            <div className="grid gap-3">
              ...
              <Input id="url" placeholder="Apple Podcasts, Spotify, or Listen Notes URL" value={url} onChange={(e) => setUrl(e.target.value)} onKeyDown={(e) => { if ((e.metaKey || e.ctrlKey) && e.key === 'Enter') handleAnalyze(); }} />
